...
case class AESCluster(message_width: Int, key_width: Int, metadata_width: Int, encrypts: Boolean = true, cores: Int = 2) extends Component {
  ...
  val cluster = Seq.fill(cores)(AESCore(message_width, key_width, metadata_width, encrypts, threads))
